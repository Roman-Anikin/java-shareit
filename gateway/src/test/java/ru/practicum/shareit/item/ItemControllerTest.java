...
public class ItemControllerTest {
    ...
    public void addItem() throws Exception {
        ...
        when(client.add(any(), any())).thenReturn(new ResponseEntity<>(itemDto, HttpStatus.OK));
    ...
    public void updateItem() throws Exception {
        ItemDto itemDto = new ItemDto(1L, "item", "desc", true, null);
        when(client.update(any(), any(), any())).thenReturn(new ResponseEntity<>(itemDto, HttpStatus.OK));
    ...
    public void updateItemNameOnly() throws Exception {
        ...
        when(client.update(any(), any(), any())).thenReturn(new ResponseEntity<>(updatedItem, HttpStatus.OK));
    ...
    public void getItemById() throws Exception {
        OwnerItemDto itemDto = new OwnerItemDto(1L, "item", "desc", true,
                null, null, null, null);
        when(client.getById(any(), any())).thenReturn(new ResponseEntity<>(itemDto, HttpStatus.OK));
    ...
    public void getItemsByOwner() throws Exception {
        ...
        OwnerItemDto itemDto2 = new OwnerItemDto(2L, "new item", "new desc", false,
                null, null, null, null);
        when(client.getByOwner(any(), any(), any()))
    ...
    public void getItemsBySearch() throws Exception {
        ...
        when(client.searchByText(any(), any(), any(), any()))
                .thenReturn(new ResponseEntity<>(List.of(itemDto, itemDto2), HttpStatus.OK));

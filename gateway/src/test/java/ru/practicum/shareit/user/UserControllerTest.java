...
public class UserControllerTest {
    ...
    public void addUser() throws Exception {
        ...
        when(client.add(any())).thenReturn(new ResponseEntity<>(user, HttpStatus.OK));
    ...
    public void addWithMailExist() throws Exception {
        UserDto user = new UserDto(1L, "user", "qwe@mail.com");
        when(client.add(any())).thenReturn(new ResponseEntity<>(HttpStatus.CONFLICT));
    ...
    public void addWithoutMail() throws Exception {
        ...
        when(client.add(any())).thenReturn(new ResponseEntity<>(HttpStatus.BAD_REQUEST));
    ...
    public void update() throws Exception {
        UserDto user = new UserDto(1L, "user", "qwe@mail.com");
        when(client.update(any(), any())).thenReturn(new ResponseEntity<>(user, HttpStatus.OK));
    ...
    public void updateNameOnly() throws Exception {
        ...
        when(client.update(any(), any())).thenReturn(new ResponseEntity<>(updatedUser, HttpStatus.OK));
    ...
    public void updateWithMailExist() throws Exception {
        UserDto user = new UserDto(1L, "user", "qwe@mail.com");
        when(client.update(any(), any())).thenReturn(new ResponseEntity<>(HttpStatus.CONFLICT));
    ...
    public void delete() throws Exception {
        doNothing().when(client).delete(anyLong());
    ...
    public void getById() throws Exception {
        UserDto user = new UserDto(1L, "user", "qwe@mail.com");
        when(client.getById(anyLong())).thenReturn(new ResponseEntity<>(user, HttpStatus.OK));
    ...
    public void getAll() throws Exception {
        ...
        when(client.getAll()).thenReturn(new ResponseEntity<>(List.of(user, user2), HttpStatus.OK));

...
public class BookingSerializationTest {
    ...
    public void serializationTest() throws IOException {
        ...
        assertThat(json).extractingJsonPathStringValue("$.start").isEqualTo(bookingDto.getStart()
                .format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
        assertThat(json).extractingJsonPathStringValue("$.end").isEqualTo(bookingDto.getEnd()
                .format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
    ...
    public void deserializationTest() throws IOException {
        String json = "{\"id\":1," +
                "\"start\":\"" + getLTD(2).format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")) + "\"," +
                "\"end\":\"" + getLTD(3).format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")) + "\"," +
                "\"item\":" +

...
public class ItemControllerTest {
    ...
    public void getItemByIdWithBookings() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get(url + "/" + itemDto.getId())
                ...
                .andExpect(jsonPath("$.lastBooking.start", is(lastBooking.getStart()
                        .format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")))))
                .andExpect(jsonPath("$.lastBooking.end", is(lastBooking.getEnd()
                        .format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")))))
                ...
                .andExpect(jsonPath("$.nextBooking.start", is(nextBooking.getStart()
                        .format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")))))
                .andExpect(jsonPath("$.nextBooking.end", is(nextBooking.getEnd()
                        .format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")))))
